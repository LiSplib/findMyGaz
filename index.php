 ...
 * Utilisation de la route 'home' si au moins l'une des deux conditions n'est pas remplie.
 */
$app['route'] = array_key_exists('r', $_GET) ? $_GET['r'] : 'home'; //error 404 a la place de default
$app['route'] = array_key_exists($app['route'], $config['mvc.routes']) ? $app['route'] : 'home';
